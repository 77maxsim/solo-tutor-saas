...
import { z } from "zod";
import { Send, Loader2, HelpCircle, MessageSquare, Wrench } from "lucide-react";
...
interface FeedbackModalProps {
  ...
  defaultType?: "help" | "feedback" | "technical_support";
}

export function FeedbackModal({ open, onOpenChange, defaultType = "feedback" }: FeedbackModalProps) {
